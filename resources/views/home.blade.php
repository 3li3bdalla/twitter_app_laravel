...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h3 class="card-title"><i class="fab fa-twitter"></i> Twits</h3>
                ...
                <div class="card" style="margin-bottom: 5px;">
                    ...
                    <div class="card-footer bg-white">
                        <div class="row">
                            ...
                            @else
                                <div class="col-md-6"><a  href="/like/{{$twit->id}}" class="btn btn-block btn-sm text-primary"> <i class="fa fa-heart"></i> </a> </div>
